  ...
  render() {
    return (
      <div>
        <div>
          <h2>Location</h2>
          <p>Waltham Vision Care is conveniently located on the corner of Walnut Street and Moody Street. Ample
              public parking with easy access is available from Walnut Street as well as one hour free parking
              along Moody Street.
                </p>
        </div>
        <div>
